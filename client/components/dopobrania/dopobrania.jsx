    ...
    <div className="wrapper">
      <div className="wrapper__inside">
        <div className="content">
          <h1 className="content__header">DO POBRANIA</h1>
          <div className="content__article">
            <p>Zgody na udział w zbiórce do pobrania (Covid-19)</p>
            <p>
              <a
          ...
          <div className="content__article">
            <p>Wzór próby na naramiennik wędrowniczy</p>
            <p>
              <a
